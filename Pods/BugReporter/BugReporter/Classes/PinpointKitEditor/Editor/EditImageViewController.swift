...
class EditImageViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    var barButtonItemProvider: EditImageViewControllerBarButtonItemProviding? {
        get {
     ...
     */
    func attemptToDismiss(animated: Bool) {
...
private class DefaultBarButtonItemProvider: EditImageViewControllerBarButtonItemProviding {
    let leftBarButtonItem: UIBarButtonItem? = nil
    let rightBarButtonItem: UIBarButtonItem?
    let hidesBarButtonItemsWhileEditingTextAnnotations = true
    
    init(interfaceCustomization: InterfaceCustomization, rightBarButtonItemTarget: AnyObject?, rightBarButtonItemSelector: Selector) {
